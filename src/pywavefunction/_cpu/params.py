...
get_min_distance_to_asymptote_jit: Callable = jit(  # type: ignore[pylance]
...
set_min_distance_to_asymptote_jit: Callable = jit(  # type: ignore[pylance]
...
get_integration_step_jit: Callable = jit(get_integration_step)  # type: ignore[pylance]
...
set_integration_step_jit: Callable = jit(set_integration_step)  # type: ignore[pylance]
...
get_last_level_index_jit: Callable = jit(get_last_level_index)  # type: ignore[pylance]
...
set_last_level_index_jit: Callable = jit(set_last_level_index)  # type: ignore[pylance]
...
get_reduced_mass_jit: Callable = jit(get_reduced_mass)  # type: ignore[pylance]
...
set_reduced_mass_jit: Callable = jit(set_reduced_mass)  # type: ignore[pylance]
...
get_potential_well_max_y_jit: Callable = jit(get_potential_well_max_y)  # type: ignore[pylance]
...
set_potential_well_max_y_jit: Callable = jit(set_potential_well_max_y)  # type: ignore[pylance]
...
get_potential_well_min_y_jit: Callable = jit(get_potential_well_min_y)  # type: ignore[pylance]
...
set_potential_well_min_y_jit: Callable = jit(set_potential_well_min_y)  # type: ignore[pylance]
...
get_lower_energy_search_limit_jit: Callable = jit(  # type: ignore[pylance]
...
set_lower_energy_search_limit_jit: Callable = jit(  # type: ignore[pylance]
...
get_upper_energy_search_limit_jit: Callable = jit(  # type: ignore[pylance]
...
set_upper_energy_search_limit_jit: Callable = jit(  # type: ignore[pylance]
...
get_energy_value_to_check_jit: Callable = jit(get_energy_value_to_check)  # type: ignore[pylance]
...
set_energy_value_to_check_jit: Callable = jit(set_energy_value_to_check)  # type: ignore[pylance]
...
get_distance_to_asymptote_jit: Callable = jit(get_distance_to_asymptote)  # type: ignore[pylance]
...
set_distance_to_asymptote_jit: Callable = jit(set_distance_to_asymptote)  # type: ignore[pylance]
...
update_search_limits_jit: Callable = jit(update_search_limits)  # type: ignore[pylance]
